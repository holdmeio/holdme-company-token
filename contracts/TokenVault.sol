...
contract TokenVault is Ownable {
  ...
  UpgradeableStandard23Token public token;
   ...
   *
   */
  function TokenVault(address _owner, uint _freezeEndsAt, UpgradeableStandard23Token _token) {
  ...
  function claim() {
    ...
    require(balances[investor] > 0);    // Investor is in our list
    require(claimed[investor] == 0);    // Investor hasn't claimed
